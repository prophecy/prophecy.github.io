...
In the same way that linear force is described by **ΣF = ma**, rotational force is described by torque, which is explained by **τ = r F<sub>br</sub> sin(θ)**
...
Imagine when you brake hard at the front—you're gonna get OTB because of what? "Your rear wheel lifts." So another torque comes into play, described by **τ<sub>counter</sub> = Lmg** where **L = horizontal length between front wheel's contact point and CoM**
