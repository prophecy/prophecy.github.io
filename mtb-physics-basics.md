...
![MTB Physics Basics Elements](mtb-physics-basics/mtb-physics-basics.png)
...
**Front/Rear Brake Force** = Deceleration forces applied when the rider engages the brake levers